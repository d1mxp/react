  ...
  return (
    <div>
      <div className={style.contener}>
        ...
        <div>
          <h3 className={style.titH}> MY BIOGRAPHY</h3>
          <p>
            ...
            journey that has spanned over 15 years. <br />
            ...
            keen eye for detail and an innate ability to capture raw emotions
            that truly set her apart. <br />
            Damien's journey is more than just taking pictures; it's about
            capturing the essence of the human spirit, the fleeting magic of
            nature, and the emotions that define our lives. With each click of
            her camera, she weaves stories that transcend time and space.
          </p>
        </div>
      </div>
    </div>
