      ...
      <div className={style.contener}>
        <div className={style.block}>
          <div className={style.title}>
            ...
            <p className={style.p}>
              In the world of business, a compelling image can make all the
              difference. Our commercial photography service is designed to
              enhance your brand's visual identity. We create striking images
              for your products, services, and marketing campaigns that leave a
              lasting impact on your audience.
            </p>
            <button className={style.imgLink}>VIEW PROJECT &#8599;</button>
          </div>
        ...
        <div className={style.infoblock}>
          <div className={style.titleblock}>
            ...
            <div className={style.priceblock}>
              ...
              <button className={style.imgLink}>BOOK A CALL &#8599;</button>
            </div>
          </div>
          <div className={style.Contact}>
            <div className={style.text}>
              {" "}
              <img className={style.imgDot} src={DOT} />{" "}
              <p>
